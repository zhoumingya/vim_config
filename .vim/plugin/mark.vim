...
if ! exists('g:mwDefaultHighlightingPalette')
	let g:mwDefaultHighlightingPalette = 'yehual'
endif
...
let g:mwPalettes['yehual'] =  [
		\   { 'ctermbg':'Blue',       'ctermfg':'White', 'guibg':'#A1B7FF', 'guifg':'#001E80' },
		...
		\   { 'ctermbg':'Gray',       'ctermfg':'Green', 'guibg':'#A3A396', 'guifg':'#222222' },
		\   { 'ctermbg':'Cyan',   	  'ctermfg':'DarkRed','guibg':'#D2A1FF', 'guifg':'#420080' },
		\   { 'ctermbg':'White',      'ctermfg':'Blue',  'guibg':'#E3E3D2', 'guifg':'#999999' },
		\   { 'ctermbg':'Cyan',       'ctermfg':'Black', 'guibg':'#A1FEFF', 'guifg':'#007F80' },
		\   { 'ctermbg':'Magenta',	  'ctermfg':'Blue', 'guibg':'#A29CCF', 'guifg':'#120080' },
		\   { 'ctermbg':'Gray',       'ctermfg':'Blue',  'guibg':'#A3A396', 'guifg':'#222222' },
		\   { 'ctermbg':'DarkRed',    'ctermfg':'Black', 'guibg':'#F5A1FF', 'guifg':'#720080' },
		\   { 'ctermbg':'White',      'ctermfg':'Green', 'guibg':'#E3E3D2', 'guifg':'#999999' },
		\   { 'ctermbg':'Brown',      'ctermfg':'Black', 'guibg':'#FFC4A1', 'guifg':'#803000' },
		\   { 'ctermbg':'Blue',   	  'ctermfg':'DarkRed','guibg':'#A1DBFF', 'guifg':'#004E80' },
		\   { 'ctermbg':'Yellow',     'ctermfg':'Green',  'guibg':'#FFE8A1', 'guifg':'#806000' },
		\   { 'ctermbg':'Green',      'ctermfg':'DarkRed','guibg':'#ACFFA1', 'guifg':'#0F8000' },
		\   { 'ctermbg':'White',      'ctermfg':'DarkRed','guibg':'#E3E3D2', 'guifg':'#999999' },
		\   { 'ctermbg':'Magenta',	  'ctermfg':'White', 'guibg':'#A29CCF', 'guifg':'#120080' },
		\   { 'ctermbg':'Yellow',     'ctermfg':'Blue',  'guibg':'#FFE8A1', 'guifg':'#806000' },
		\   { 'ctermbg':'Brown',      'ctermfg':'Red', 'guibg':'#FFC4A1', 'guifg':'#803000' },
		...
		\   { 'ctermbg':'Yellow',     'ctermfg':'DarkRed',  'guibg':'#FFE8A1', 'guifg':'#806000' },
		\]
