...
let alternateExtensionsDict["h/c"] = {}
let alternateExtensionsDict["->unittest"] = {}
...
" E.g. let g:alternateExtensions_CPP = "inc,h,hh,H,HPP,hpp"
...
function! <SID>AddAlternateExtensionMapping(type, extension, alternates)
   ...
   let g:alternateExtensionsDict[a:type][a:extension] = a:alternates
...
call <SID>AddAlternateExtensionMapping("h/c", 'h',"c,cpp,cxx,cc,CC")
call <SID>AddAlternateExtensionMapping("h/c", 'hh',"c,cpp,cxx,cc,CC")
call <SID>AddAlternateExtensionMapping("h/c", 'H',"C,CPP,CXX,CC")
call <SID>AddAlternateExtensionMapping("h/c", 'hpp',"cpp,c")
call <SID>AddAlternateExtensionMapping("h/c", 'HPP',"CPP,C")
call <SID>AddAlternateExtensionMapping("h/c", 'c',"h")
call <SID>AddAlternateExtensionMapping("h/c", 'C',"H")
call <SID>AddAlternateExtensionMapping("h/c", 'cpp',"h,hpp")
call <SID>AddAlternateExtensionMapping("h/c", 'CPP',"H,HPP")
call <SID>AddAlternateExtensionMapping("h/c", 'cc',"h")
call <SID>AddAlternateExtensionMapping("h/c", 'cc',"hh")
call <SID>AddAlternateExtensionMapping("h/c", 'CC',"H,h")
call <SID>AddAlternateExtensionMapping("h/c", 'CC',"HH,hh")
call <SID>AddAlternateExtensionMapping("h/c", 'cxx',"h")
call <SID>AddAlternateExtensionMapping("h/c", 'CXX',"H")
" Mappings for PSL7
call <SID>AddAlternateExtensionMapping("h/c", 'psl',"ph")
call <SID>AddAlternateExtensionMapping("h/c", 'ph',"psl")
" Mappings for ADA
call <SID>AddAlternateExtensionMapping("h/c", 'adb',"ads")
call <SID>AddAlternateExtensionMapping("h/c", 'ads',"adb")
" Mappings for lex and yacc files
call <SID>AddAlternateExtensionMapping("h/c", 'l',"y,yacc,ypp")
call <SID>AddAlternateExtensionMapping("h/c", 'lex',"yacc,y,ypp")
call <SID>AddAlternateExtensionMapping("h/c", 'lpp',"ypp,y,yacc")
call <SID>AddAlternateExtensionMapping("h/c", 'y',"l,lex,lpp")
call <SID>AddAlternateExtensionMapping("h/c", 'yacc',"lex,l,lpp")
call <SID>AddAlternateExtensionMapping("h/c", 'ypp',"lpp,l,lex")
" Mappings for OCaml
call <SID>AddAlternateExtensionMapping("h/c", 'ml',"mli")
call <SID>AddAlternateExtensionMapping("h/c", 'mli',"ml")
" ASP stuff
call <SID>AddAlternateExtensionMapping("h/c", 'aspx.cs', 'aspx')
call <SID>AddAlternateExtensionMapping("h/c", 'aspx.vb', 'aspx')
call <SID>AddAlternateExtensionMapping("h/c", 'aspx', 'aspx.cs,aspx.vb')

call <SID>AddAlternateExtensionMapping("->unittest", 'cc', 'unittest.cc')
call <SID>AddAlternateExtensionMapping("->unittest", 'hh', 'unittest.cc')
call <SID>AddAlternateExtensionMapping("->unittest", 'unittest.cc', 'cc,hh')

" Setup default search path, unless the user has specified
" a path in their [._]vimrc. 
if (!exists('g:alternateSearchPath'))
  let g:alternateSearchPath = 'sfr:../source,sfr:../src,sfr:../include,sfr:../inc,sfr:../test/unittest,sfr:../../src'
endif
...
" Author   : Michael Sharpe <feline@irendi.com>
function! EnumerateFilesByExtension(type, path, baseName, extension)
   let enumeration = ""
   let extSpec = ""
   let v:errmsg = ""
   silent! echo g:alternateExtensions_{a:extension}
   ...
   if (extSpec == "")
      if (has_key(g:alternateExtensionsDict[a:type], a:extension))
         let extSpec = g:alternateExtensionsDict[a:type][a:extension]
      endif
   endif
   if (extSpec != "") 
      let n = 1
...
" Author   : Michael Sharpe <feline@irendi.com>
function! EnumerateFilesByExtensionInPath(type, baseName, extension, pathList, relPathBase)
   let enumeration = ""
   let filepath = ""
   let m = 1
   let pathListLen = strlen(a:pathList)
   if (pathListLen > 0)
      while (1)
         ...
         if (pathSpec != "")
            let path = <SID>ExpandAlternatePath(pathSpec, a:relPathBase)
            let pe = EnumerateFilesByExtension(a:type, path, a:baseName, a:extension)
            if (enumeration == "")
               let enumeration = pe
            else
...
"            message.
function! DetermineExtension(type, path) 
  let prefix = ":t"
  let rawmods = ""
  for i in range(s:maxDotsInExtension + 1)
      let rawmods = rawmods . ":e"
  endfor

  let i = s:maxDotsInExtension + 1
  while (i > 0)
    let mods = prefix . rawmods
    let extension = fnamemodify(a:path, mods)
    if (has_key(g:alternateExtensionsDict[a:type], extension))
       return extension
    endif
    let v:errmsg = ""
...
function! AlternateFile(type, splitWindow, ...)
  let extension   = DetermineExtension(a:type, expand("%:p"))
  ...
  if (a:0 != 0)
     ...
     let allfiles = ""
     if (extension != "")
        let allfiles1 = EnumerateFilesByExtension(a:type, currentPath, baseName, extension)
        let allfiles2 = EnumerateFilesByExtensionInPath(a:type, baseName, extension, g:alternateSearchPath, currentPath)
...
comm! -nargs=? -bang A call AlternateFile('h/c', "n<bang>", <f-args>)
comm! -nargs=? -bang AS call AlternateFile('h/c', "h<bang>", <f-args>)
comm! -nargs=? -bang AV call AlternateFile('h/c', "v<bang>", <f-args>)
comm! -nargs=? -bang AT call AlternateFile('h/c', "t<bang>", <f-args>)
comm! -nargs=? -bang AN call NextAlternate('h/c', "<bang>")

comm! -nargs=? -bang B call AlternateFile('->unittest', "n<bang>", <f-args>)
comm! -nargs=? -bang BS call AlternateFile('->unittest', "h<bang>", <f-args>)
comm! -nargs=? -bang BV call AlternateFile('->unittest', "v<bang>", <f-args>)
comm! -nargs=? -bang BT call AlternateFile('->unittest', "t<bang>", <f-args>)
